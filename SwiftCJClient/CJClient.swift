...
public class CJClient {
    ...
    public typealias SuccessInterceptor = (CJClient, NSHTTPURLResponse) -> Bool

    public init(extMan: AFHTTPSessionManager, cjMan: AFHTTPSessionManager) {
        self.extMan = extMan
        self.cjMan = cjMan
    }
    ...
    public func get(href: NSURL) -> Future<CJCollection, NSError> {
    ...
    public func delete(href: NSURL) -> Future<Bool, NSError> {
    ...
    public func query(query: CJQuery) -> Future<CJCollection, NSError> {
        let promise = Promise<CJCollection, NSError>()
    ...
    public func put(href: NSURL, template: CJTemplate) -> Future<CJCollection, NSError> {
        let promise = Promise<CJCollection, NSError>()
    ...
    public func post(href: NSURL, template: CJTemplate) -> Future<CJCollection, NSError> {
        let promise = Promise<CJCollection, NSError>()
    ...
    public func postIntercept(href: NSURL, template: CJTemplate, successInterceptor: SuccessInterceptor) -> Future<CJCollection,NSError> {
        let promise = Promise<CJCollection, NSError>()
    ...
    public func upload(href: NSURL, data: NSData) -> Future<String?, NSError> {
        let promise = Promise<CJCollection,NSError>()
    ...
    public func download(href: NSURL) -> Future<NSData, NSError> {
